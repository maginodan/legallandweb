...
const articles = [
  {
    title: `Navigating Customary Land Disputes with Expertise`,
    image: `/images/case-1.webp`,
    alt: `Customary Land Case`,
  },
  {
    title: `Securing Land Titles Through Legal Guidance`,
    image: `/images/case-2.webp`,
    alt: `Land Title Success`,
  },
  {
    title: `Resolving Leasehold Conflicts with Professional Support`,
    image: `/images/case-3.webp`,
    alt: `Leasehold Dispute Resolution`,
  },
];
    ...
    <div className={tw(`w-full min-h-screen bg-gray-900 relative`)}>
      ...
      <div className={tw(`max-w-7xl mx-4 lg:mx-auto pt-20 lg:pt-40`)}>
        <h1 className={tw(`text-white text-4xl lg:text-7xl font-bold text-center`)}>
          Resolve Your Land Issues
        </h1>
        <p className={tw(`text-white text-gray-400 text-center text-xl mt-12`)}>
          Hear from clients who secured land ownership with our expert guidance
        </p>
            ...
            {articles.map((article) => (
              ...
              >
                ...
                <div className={tw(`p-4 shadow-lg w-full mx-auto -mt-8 bg-white rounded-b z-30 relative`)}>
                  <p className={tw(`uppercase text-sm text-gray-700 text-center pb-1`)}>
                    Land Law Case
                  </p>
                  <p className={tw(`text-gray-500 text-center pb-1 text-sm`)}>
                    {article.title}
                  </p>
                </div>
              </div>
